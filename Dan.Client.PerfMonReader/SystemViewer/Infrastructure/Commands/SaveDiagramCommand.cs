...
namespace SystemViewer.Infrastructure.Commands
{
    ...
    public class SaveDiagramCommand : ICommand
    {
        ...
        /// The filename.
        /// </param>
        public static void SaveDocument(DiagramCanvas canvas, string filename)
        {


            canvas.Save_Executed(canvas,null);
            //string mystrXaml = System.Windows.Markup.XamlWriter.Save(canvas);
        ...
        public void Execute(object parameter)
        {
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    SaveDocument(diagram, filename);
                    MessageBox.Show(string.Format("Diagram {0} Saved", filename), "Save Document", MessageBoxButton.OK);
                }
